 ...
 * @author mdames
 */
class GetEntryMp3Name extends CliCmd {

    @Override
    String getName() {
        return("get-entry-mp3-name");
    }

    @Override
    String getDescription() {
        return("get-entry-mp3-name <oid>");
    }
    ...
    int execute(String[] args) {
        ...
        System.out.println(CLI.getBook().getEntryByOID(oid).getMP3().getName());
        return(ok());
    }
